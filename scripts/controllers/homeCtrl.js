app.controller("homeCtrl", function() {
	...
	self.bio = {
		...
		aboutWeb: "My name is Jon Pearman and I'm an aspiring web developer. " + 
			"I have been developing for about a year and I'm completely self taught. " + 
			"Web development has become a very large passion in my life. I have always been 'computer savy' " +
			...
			"It's something most people use every single day and it is only becoming a larger part of our lives! " +
			"Learning the ins and outs of this vast area has been a very enriching experience that I intend to continue " +
			"for the rest of my life. For me, web development has become a life style. It's different from other " +
			"professions because it's constantly improving, updating, innovating; that's exciting! " +
			"It's a life style because you can never stop learning. You can never stop improving. " +
			"There's something very gratify about revisiting some code you wrote a month ago and thinking " +
			"of new ways to improve it, or to make it more maintainable, or just flat out change it completely.",
		
		aboutSoccer: "Aside from web development I am hugely passionate about soccer. I have been a soccer play all my life " +
			...
			"Soccer has been the single largest influence in my life. It's taught me so many lessons " +
		...
		aboutFood: "Last but not least, I love food! Mainly eating and cooking it, but it isn't too bad to " +
			...
			"to cook properly. I love to use new ingredients and try a recipe I haven't done yet. " +
